...
class CustomerViewSet(viewsets.ModelViewSet):
    ...
    def create_customer(self, request):
        ...
        if data["address"]:
            ...
            if response["status"] == "OK":
                ...
                return Response(
                    {"detail": "Your address is not founded! Please try again!"},
                    status=status.HTTP_400_BAD_REQUEST,
                )
        else:
            return Response(
                {"detail": "Please input address"}, status=status.HTTP_400_BAD_REQUEST
            )
        ...
        if serializer.is_valid():
            ...
            return Response(
                {"detail": "Customer information is invalid! Please try again!"},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def update_customer(self, request):
        ...
        return Response(
            {"detail": "Customer is not founded!"}, status=status.HTTP_404_NOT_FOUND
        )
    ...
    def delete_customer(self, request):
        ...
        if customer:
            customer.delete()
            return Response(
                {"detail": "Customer is deleted!"}, status=status.HTTP_200_OK
            )
        return Response(
            {"detail": "Customer is not founded!"}, status=status.HTTP_404_NOT_FOUND
        )
